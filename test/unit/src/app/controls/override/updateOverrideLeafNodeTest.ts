...
describe('update override leaf node test', () => {
	...
	describe('when there is no value in the override for the setting', () => {
	...
	describe('when there is a value in the override for the setting', () => {
		describe('when there is no value in the combined effect for the setting', () => {
			it('sets overriding to false when the override value matches the default value', () => {
			...
			it('sets overriding to true when the override value does not match the default value', () => {
		...
		describe('when there is a value in the combined effect for the setting', () => {
