...
const createLogo: NullarySideEffector =
	(): void => {
		...
		const logo: SVGSVGElement = document.createElementNS(xmlns, 'svg') as any
		const width = 46 * LOGO_SCALE
		const height = 10 * LOGO_SCALE
