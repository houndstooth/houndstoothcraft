...
./bin/shared/cmd_w_msgs.sh "./bin/cover.sh" "running unit tests and covering" "Unit tests failed, or coverage did not meet threshold." "Unit tests passed with latest code, and coverage report updated."
