...
// import stateMaps from '../../state/stateMaps'
//
...
// 		// })
//
// 		// stateMaps.state.get('gridConfig').gridSize = 2
// 		// stateMaps.state.get('viewConfig').canvasSize = 100
//
// 		execute({
// 			iterating: false,
// 			animating: false,
...
// 	const sectorSize = stateMaps.state.get('tileConfig').tileSize / n
