...
describe('standard animation', () => {
	it('multiplies the property by the standard animation rate each frame', () => {
		...
		expect(standardAnimation.main(propertyAtCurrentFrame)).toBe(propertyAtCurrentFrame)
		...
		expect(standardAnimation.main(propertyAtCurrentFrame)).toBe(propertyAtNextFrame)
